...
const { chatJson, resolveLlm, describeImage } = require('./llm.js');
...
async function describeImage(imageBase64) {
  ...
  return describeImage(llm, model, raw, 'Describe this image in detail so the description can be used as context for questions later. Include any text, data, or meaning visible.');
}
